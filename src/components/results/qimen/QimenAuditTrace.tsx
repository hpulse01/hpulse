...
export function QimenAuditTrace({ engineOutput }: Props) {
  if (!engineOutput) {
    return <div className="rounded-md border border-primary/15 bg-card/30 px-3 py-2 text-xs text-muted-foreground">奇门 EngineOutput 不可用 / Qimen audit unavailable.</div>;
  }
