...
export function LiuYaoAuditTrace({ engineOutput }: Props) {
  if (!engineOutput) {
    return <div className="rounded-md border border-primary/15 bg-card/30 px-3 py-2 text-xs text-muted-foreground">六爻 EngineOutput 不可用 / Liu Yao audit unavailable.</div>;
  }
