  ...
  return {
    eo: {
      ...
      normalizedOutput: {
        ...
        '错卦': result.analysis.cuoGua.gua.name,
        '综卦': result.analysis.zongGua.gua.name,
        ...
        '多层体用': result.analysis.multiLayerTiYong.synthesis,
        '五行力量': result.analysis.wuxingBalance.interpretation,
      },
