...
/** v3.0: 地空地劫查表 (以年支查) */
const DIKONG_TABLE: Record<string, string> = { '子': '亥', '丑': '戌', '寅': '酉', '卯': '申', '辰': '未', '巳': '午', '午': '巳', '未': '辰', '申': '卯', '酉': '寅', '戌': '丑', '亥': '子' };
const DIJIE_TABLE: Record<string, string> = { '子': '丑', '丑': '寅', '寅': '卯', '卯': '辰', '辰': '巳', '巳': '午', '午': '未', '未': '申', '申': '酉', '酉': '戌', '戌': '亥', '亥': '子' };

/** v3.0: 博士十二神 (以禄存所在宫位起博士，顺行十二宫) */
