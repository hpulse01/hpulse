...
const WEIGHT_TABLE: Record<QueryType, WeightConfig[]> = {
  ...
  annualForecast: [
    ...
    { engineName: 'western', weight: 0.14, reason: '西方占星行星过运与年度预测相关' },
    { engineName: 'vedic', weight: 0.16, reason: '吠陀Dasha分期在年度预测中权重较高' },
    { engineName: 'numerology', weight: 0.08, reason: '个人年数字对年度预测有参考' },
    { engineName: 'mayan', weight: 0.06, reason: '玛雅周期参考' },
    { engineName: 'kabbalah', weight: 0.06, reason: '卡巴拉灵性参考' },
  ],
  monthlyForecast: [
    { engineName: 'tieban', weight: 0.10, reason: '铁板流月条文可用但精度有限' },
    { engineName: 'bazi', weight: 0.17, reason: '八字流月天干地支分析为月度核心' },
    { engineName: 'ziwei', weight: 0.15, reason: '紫微流月盘对月度运势分析较强' },
    { engineName: 'liuyao', weight: 0.11, reason: '六爻月度占卜有一定参考价值' },
    { engineName: 'western', weight: 0.13, reason: '西方占星月亮周期与月度高度相关' },
    { engineName: 'vedic', weight: 0.11, reason: '吠陀月宿与月度分析相关' },
  ...
  dailyForecast: [
    { engineName: 'bazi', weight: 0.16, reason: '八字日柱与流日天干关系为日度核心' },
    { engineName: 'ziwei', weight: 0.10, reason: '紫微流日参考' },
    { engineName: 'liuyao', weight: 0.18, reason: '六爻日占为即时预测强项' },
    { engineName: 'western', weight: 0.14, reason: '西方占星每日行星相位' },
    { engineName: 'vedic', weight: 0.09, reason: '吠陀日宿参考' },
    { engineName: 'numerology', weight: 0.07, reason: '数字日度参考' },
    { engineName: 'mayan', weight: 0.09, reason: '玛雅Kin日签高度相关' },
