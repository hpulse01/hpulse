...
const WEIGHT_TABLE: Record<QueryType, WeightConfig[]> = {
  ...
  monthlyForecast: [
    ...
    { engineName: 'bazi', weight: 0.18, reason: '八字流月天干地支分析为月度核心' },
    { engineName: 'ziwei', weight: 0.16, reason: '紫微流月盘对月度运势分析较强' },
    { engineName: 'liuyao', weight: 0.12, reason: '六爻月度占卜有一定参考价值' },
    ...
    { engineName: 'mayan', weight: 0.06, reason: '玛雅Uinal周期' },
    { engineName: 'kabbalah', weight: 0.06, reason: '卡巴拉月度参考' },
  ],
  dailyForecast: [
