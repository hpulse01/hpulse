/* @ts-self-types="./hpulse_input.d.ts" */
 ...
 * @returns {any}
 */
export function normalize_input(raw_js) {
    const ret = wasm.normalize_input(addHeapObject(raw_js));
